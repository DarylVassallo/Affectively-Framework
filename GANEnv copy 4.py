...
class GANLevelEnv(gym.Env):
    def __init__(self, gan_model=GANWrapper(), level_dim=32):
        ...
        self.observation_list = deque(maxlen=5)
    ...
    def reset(self, *, seed=None, options=None):
        ...
        while len(self.observation_list) <= 0:
            ...
            if self.playable:    
                ...
                for i in range(5):
                    self.observation_list.append(self.current_action)
    ...
    def step(self, action):
        ...
        if self.playable and self.segment_count < self.step_max_count:
            ...
            score, enemy_count = self.reward(self.current_segment)
...
# 7 7 7 7 7 
    ...
    def _get_observation_stack(self):
        stacked = np.stack(self.observation_list, axis=0).flatten()
